<template>
  <div class="container">
    ...
    <ul class="label-list wn-list">
      <li v-for="(nav,index) in navs" v-bind:class="{active:(indexs==index)}" v-on:click="getIndex(index)">
        <a href="javascript:void(0)" class="tab-link button"> {{ nav.message }}</a>
      </li>
    </ul>
    <div class="blog-list-container">
      <div class="webnav about-me bga-back-top">
        <div class="wn-box" v-for="(content, index) in contents" v-if="indexs == index">
          <h1>{{content.h1}}</h1>
