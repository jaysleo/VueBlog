<template>
  ...
  <div>
      <div class="left-layout-container pc">
        ...
        <ul class="left-menu">
          <router-link :class="isBlog ? 'selected-menu':''" tag="li" :to="{name: 'BlogList'}"><span>个人博客</span></router-link>
      ...
      <div class="navbar">
        <nav>
          ...
          <!--标题-->
          <h1 class="nav_title"><p>个人博客</p></h1>
          <!--右侧图标-->
<!--           <div class="nav_r">
            <a href="javascript:;">
              <i class="icon-search" />
      ...
      <div class="left-user">
        ...
        <div class="left-layout-container" v-if="showMenu">
          ...
          <ul class="left-menu">
            <router-link :class="isBlog ? 'selected-menu':''" tag="li" :to="{name: 'BlogList'}" @click.native="toggleMenu()"><span>个人博客</span></router-link>
