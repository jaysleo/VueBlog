...
const state = {
  ...
  auth: {
    ...
    clientID: 'c2463be9a88aac90024c',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: 'd2d34ba96c4f92233f26ef8a4740769838d90ecc'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'jaysleo',  // 修改成你自己的 GitHub 账号
  copyright: '2017 - 2019',  // 修改成你自己的
  recordNumber: 'null',  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'jaysleo/mblog',  // 记录 Issue 的仓库的全名「用户名/仓库名」
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/jaysleo'  // 第三方站点的 url
    }
